...
/**
 * R15 (owner ruling, 2026-09-20, owner exit proof P2) — `variants/out_of_stock`,
 * the boundary transition that actually matters for advertised purchasability.
 * See `inventoryPurchasabilityHandler.server.ts` for what this does and,
 * just as importantly, does not do with the delivered payload.
 *
