...
Resolved 2026-09-17 and clarified 2026-09-18, owner-directed: **D9** = cash-first pricing. The authoritative business price is the cash-equivalent price; credit-card price is derived only after cash pricing/floors are final at a configurable, versioned +5%. Cash-equivalent methods are ACH, wire, Zelle, and check. Card-processing expense does not reduce the cash gross-margin or minimum-profit floors. Customer display is card-first with the discounted cash-equivalent price alongside it. `docs/CASH-CARD-PRICING.md` controls any conflict. **D15** = daily recalculation, configurable. **D14 is resolved for core pricing** — target markup on cost 40%, minimum margin 20%, minimum dollar profit $100, whole-dollar rounding; automatic publication remains separately gated by its enablement/tolerance controls.
...
| D9 | ~~Payment methods and payment pricing~~ **RESOLVED 2026-09-17; clarified 2026-09-18.** The authoritative base price is the **cash-equivalent** price for ACH, wire, Zelle, and check. All markup, 20% margin-floor, $100 minimum-profit, Group Buy tier/freeze/refund, override, and recalculation economics operate on cash price. Credit-card price is derived **after** cash price is final: `credit_card_price = cash_price x (1 + card_uplift_rate)`, MVP1 default **5%**, configurable/versioned. Card-processing expense is not deducted from the current cash floor calculations. Customer display is card-first; cash is shown as the discounted cash-equivalent price. Never advertise a fixed 5% cash-discount percentage. `docs/CASH-CARD-PRICING.md` controls any conflict. | — | — |
