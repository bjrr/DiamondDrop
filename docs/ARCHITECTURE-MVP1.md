...
Resolved 2026-09-18, owner-directed: **D9** is superseded by the Bank-vs-Card pricing model in `docs/BANK-CARD-PRICING.md`. The **Bank Payment Price** is the actual underlying calculated selling price and must not be altered by the bank-vs-card feature. The **Regular/Card Price** is derived afterward from a tier selected exclusively from Bank Payment Price: < $500 +5.0%; $500–$999.99 +4.5%; $1,000–$2,499.99 +4.0%; $2,500–$4,999.99 +3.5%; $5,000+ +3.0%. Only the Regular/Card Price is rounded, always upward to the next $5 increment. The final rounded Regular/Card Price is the primary displayed/Shopify price; customer-facing terminology uses **Bank Payment Price** and exact dollar savings, never the internal percentage or fee/surcharge wording. Historical fixed-5% pricing remains reproducible under its existing versioned rule id and must not be mutated. **D15** = daily recalculation, configurable. **D14 is resolved for core pricing** — target markup on cost 40%, minimum margin 20%, minimum dollar profit $100; the Bank-vs-Card feature does not alter the underlying Bank Payment Price.
